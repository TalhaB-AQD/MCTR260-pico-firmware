...
| Motors keep running after app closes | BLE disconnect not detected | Check `onDisconnect` callback in `ble_controller.cpp`; it should call `motor_manager.stopAll()` |
