...
| Motors (up to 4) | DC or stepper, depending on your build | All 4 should be the same type |
...
> [!TIP]
> If this is your first time, read [GETTING_STARTED.md](GETTING_STARTED.md) for a detailed walkthrough of every step.

1. Open this folder (`firmwares/pico/`) in VS Code with PlatformIO installed
...
│   └── profiles/           # Motion profiles (mecanum drive, etc.)
...
| DC Motors | ✅ | DRV8871, DRV8833, L298N drivers |
...
|----------|----------------|
| [GETTING_STARTED.md](GETTING_STARTED.md) | First time setting up? Start here. |
| [CONFIGURATION_REFERENCE.md](CONFIGURATION_REFERENCE.md) | Need to understand a specific setting in `project_config.h` |
| [WIRING_GUIDE.md](WIRING_GUIDE.md) | Wiring your motors, drivers, and MCP23017 chips |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Want to understand how the firmware code works internally |
