...
**Good names:** `PicoBot_05`, `RC_Tank_1`, `MecaRover_A`, `Team7_ROBOT`, `warehouse_Pico_3`

**Bad names:** `Steve`, `TestDevice`, `Board3` (no keywords, these will appear at the bottom of the scan list)
