 ...
 *
 * Driver for the MCP23017 used on the MechaPico MCB to control
 * stepper motors and other peripherals via I2C.
 *
 * MechaPico MCB Configuration:
 *   - U6_1 (0x20): Stepper motor control
 *   - U6_2 (0x21): DC motors, LEDs, general I/O
 */
